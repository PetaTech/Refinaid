...
from app.playground.plum.gui.dashboard import generate_playground
from app.playground.plum.gui.dashboard import generate_data_process
from app.playground.plum.gui.dashboard import generate_motivation
from app.playground.plum.gui.dashboard import generate_trained_process
from app.playground.plum.gui.dashboard import generate_trained_results


def build_plum_playground(
        confusion, accuracy, recall, precision, proba):
    demo = gr.Blocks(
        title='梅雨還是沒雨？',
    )
